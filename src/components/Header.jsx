...
const Header = () => {
  ...
  return (
    // In Header.jsx, change the main div className to:
<div
...
>
  ...
  lg:static lg:flex lg:flex-1 lg:justify-center lg:bg-transparent`}
>

        <div className="relative z-2 flex flex-col items-center justify-center gap-8
 lg:flex-row">
